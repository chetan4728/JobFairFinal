 ...
 */
public class DiplomaFragmnet extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_diploma_fragmnet, container, false);
        ActionBar actionBar =((Dashboard) getActivity()).getSupportActionBar();
        actionBar.setHomeButtonEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setTitle("Diploma Detail");
                ...
                .setCallback(new FutureCallback<String>() {
                    ...
                    public void onCompleted(Exception e, String result) {
                        try {
                            ...
                            selectValue(course,Educational_detail.getJSONObject("diploma").getString("ed_course_name"));
                            selectValue(course_type,Educational_detail.getJSONObject("diploma").getString("ed_course_type"));
                            speciliasation.setText(Educational_detail.getJSONObject("diploma").getString("ed_specialization"));
                            insitiute.setText(Educational_detail.getJSONObject("diploma").getString("ed_university"));
                            pssing_out_year.setText(Educational_detail.getJSONObject("diploma").getString("ed_passout_yr"));
                            totalmarks.setText(Educational_detail.getJSONObject("diploma").getString("ed_total_marks_obtained"));
                            outoffmarks.setText(Educational_detail.getJSONObject("diploma").getString("ed_total_marks_out_of"));
                            pernentage.setText(Educational_detail.getJSONObject("diploma").getString("ed_percentage"));
                            grades.setText(Educational_detail.getJSONObject("diploma").getString("ed_grade"));
                            progressBar.hide();
    ...
    public void uploadMultipart(){
        ...
        if (uploadFlag == false) {
            ...
            Ion.with(getActivity())
                    ...
                    .setMultipartParameter("diploma_course_name", course.getSelectedItem().toString())
                    .setMultipartParameter("diploma_course_type", course_type.getSelectedItem().toString())
                    .setMultipartParameter("diploma_specialization", speciliasation.getText().toString())
                    .setMultipartParameter("diploma_passing_out_year", pssing_out_year.getText().toString())
                    .setMultipartParameter("diploma_total_marks_obtained", totalmarks.getText().toString())
                    .setMultipartParameter("diploma_total_marks_out_of", outoffmarks.getText().toString())
                    .setMultipartParameter("diploma_university_institute", insitiute.getText().toString())
                    .setMultipartParameter("diploma_grading_system", grades.getText().toString())
                    .setMultipartParameter("diploma_grading_system", grades.getText().toString())
                    .setMultipartParameter("c_id", sharedPreferences.pref.getString("mast_id", ""))
                    .asString()
                    .setCallback(new FutureCallback<String>() {
            ...
            Ion.with(getActivity())
                    ...
                    .setMultipartParameter("diploma_grading_system", grades.getText().toString())
                    .setMultipartParameter("c_id", sharedPreferences.pref.getString("mast_id", ""))
                    .setMultipartFile("diploma_upload_document", content_type,new File(path))
                    .asString()
                    .setCallback(new FutureCallback<String>() {
                        @Override
                        public void onCompleted(Exception e, String result) {
