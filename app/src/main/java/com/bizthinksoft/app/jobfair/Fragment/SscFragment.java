                ...
                .setCallback(new FutureCallback<String>() {
                    ...
                    public void onCompleted(Exception e, String result) {
                        try {
                            ...
                            selectValue(course,Educational_detail.getJSONObject("ten").getString("ed_board_name"));
                            insitiute.setText(Educational_detail.getJSONObject("ten").getString("ed_school_medium"));
                            pssing_out_year.setText(Educational_detail.getJSONObject("ten").getString("ed_passout_yr"));
                            totalmarks.setText(Educational_detail.getJSONObject("ten").getString("ed_total_marks_obtained"));
                            outoffmarks.setText(Educational_detail.getJSONObject("ten").getString("ed_total_marks_out_of"));
                            pernentage.setText(Educational_detail.getJSONObject("ten").getString("ed_percentage"));
                            grades.setText(Educational_detail.getJSONObject("ten").getString("ed_grade"));
                            progressBar.hide();
    ...
    public void uploadMultipart(){
        ...
        if (uploadFlag == false) {
            ...
            Ion.with(getActivity())
                    ...
                    .setMultipartParameter("ten_school_medium", insitiute.getText().toString())
                    .setMultipartParameter("ten_passing_out_year", pssing_out_year.getText().toString())
                    .setMultipartParameter("ten_total_marks_obtained", totalmarks.getText().toString())
                    .setMultipartParameter("ten_total_marks_out_of", outoffmarks.getText().toString())
                    .setMultipartParameter("ten_grading_system", grades.getText().toString())
                    .setMultipartParameter("c_id", sharedPreferences.pref.getString("mast_id", ""))
                    .asString()
                    .setCallback(new FutureCallback<String>() {
                        @Override
            ...
            Ion.with(getActivity())
                    ...
                    .setMultipartParameter("ten_board_name", course.getSelectedItem().toString())
                    .setMultipartParameter("ten_school_medium", insitiute.getText().toString())
                    .setMultipartParameter("ten_passing_out_year", pssing_out_year.getText().toString())
                    .setMultipartParameter("ten_total_marks_obtained", totalmarks.getText().toString())
                    .setMultipartParameter("ten_total_marks_out_of", outoffmarks.getText().toString())
                    .setMultipartParameter("ten_grading_system", grades.getText().toString())
                    .setMultipartParameter("c_id", sharedPreferences.pref.getString("mast_id", ""))
                    .setMultipartFile("ten_upload_document", content_type,new File(path))
                    .asString()
                    .setCallback(new FutureCallback<String>() {
                        @Override
                        public void onCompleted(Exception e, String result) {
